...
def minimize_language(language, labels, stats):
  minimize_partition("devLi", language, "conll", labels, stats)
  minimize_partition("trainLi", language, "conll", labels, stats)
  minimize_partition("testLi", language, "conll", labels, stats)
  #minimize_partition("test/story", language, "conll", labels, stats)
  #minimize_partition("test/des", language, "conll", labels, stats)
  #minimize_partition("all", language, "conll", labels, stats)


if __name__ == "__main__":
  labels = collections.defaultdict(set)
  stats = collections.defaultdict(int)
  minimize_language("bengali", labels, stats)
